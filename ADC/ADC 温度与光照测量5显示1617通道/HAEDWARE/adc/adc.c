...
void TemperatureAndLightAdcInit(void) //∂Àø⁄£¨ADC1≥ı ºªØ£¨Õ®µ¿14°¢15
{
	...
	ADC1->SMPR1 |=7<<12;//Õ®µ¿14 239.5÷‹∆⁄
	ADC1->SMPR1 |=7<<15;//Õ®µ¿15 239.5÷‹∆⁄
...
float GetTemperature( void )
{
	...
	float temperature = 0.0;
 	temperatureAdc = GetTemperatureAdc( 16 ); //Õ®µ¿15◊¢»ÎµƒAD÷µ
